...
export default defineThemeConfig({
        ...
        social: [{ icon: "github", link: "https://github.com/ttswap" }, {
                ...
                icon: { svg: '<svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Email</title><path d="M24 4.5v15c0 .85-.65 1.5-1.5 1.5H1.5C.65 21 0 20.35 0 19.5v-15c0-.85.65-1.5 1.5-1.5h21c.85 0 1.5.65 1.5 1.5zM12 12L1.5 6v1.5L12 13.5l10.5-6V6L12 12z"/></svg>' }, link: "mailto:ttswapfinance@gmail.com"
        }, {
                icon: {
