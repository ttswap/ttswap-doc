    ...
    "go": {
      ...
      "repository": {
        "after_control_variables": {
          ...
          "match": "(?<=\\brange\\b|\\bswitch\\b|;|\\bif\\b|\\bfor\\b|[<>]|<=|>=|==|!=|\\w[-%*+/]|\\w[-%*+/]=|\\|\\||&&)\\s*((?![]\\[]+)[-\\]!%*+./:<=>\\[_[:alnum:]]+)\\s*(?=\\{)"
        },
        "brackets": {
          "patterns": [
            {
        ...
        "other_struct_interface_expressions": {
          "patterns": [
            ...
            },
            {
              ...
              "match": "\\b([.\\w]+)(\\[(?:[]*.\\[{}\\w]+(?:,\\s*[]*.\\[{}\\w]+)*)?])?(?=\\{)(?<!\\b(?:struct|interface)\\b)"
            }
          ]
        },
        "other_variables": {
        ...
        "struct_variable_types_fields_multi": {
          "patterns": [
            {
              "begin": "(\\w+(?:,\\s*\\w+)*(?:\\s*[]*\\[]+{0,1}(?:<-\\s*)?\\bchan\\b(?:\\s*<-)?\\s*)+{0,1}\\s+[]*\\[]+{0,1})\\b(struct)\\b\\s*(\\{)",
              "beginCaptures": {
                "1": {
                  "patterns": [
                    {
            ...
            {
              "begin": "(\\w+(?:,\\s*\\w+)*(?:\\s*[]*\\[]+{0,1}(?:<-\\s*)?\\bchan\\b(?:\\s*<-)?\\s*)+{0,1}\\s+[]*\\[]+{0,1})\\b(interface)\\b\\s*(\\{)",
              "beginCaptures": {
                "1": {
                  "patterns": [
                    {
            ...
            {
              "begin": "(\\w+(?:,\\s*\\w+)*(?:\\s*[]*\\[]+{0,1}(?:<-\\s*)?\\bchan\\b(?:\\s*<-)?\\s*)+{0,1}\\s+[]*\\[]+{0,1})\\b(func)\\b\\s*(\\()",
              "beginCaptures": {
                "1": {
                  "patterns": [
                    {
