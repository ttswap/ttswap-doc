...
export default [
  ...
  {
    path: '/zh/docs',
    component: ComponentCreator('/zh/docs', '197'),
    routes: [
      {
        path: '/zh/docs',
        component: ComponentCreator('/zh/docs', 'a11'),
        routes: [
          {
            path: '/zh/docs',
            component: ComponentCreator('/zh/docs', 'd9f'),
            routes: [
              {
                path: '/zh/docs/',
                component: ComponentCreator('/zh/docs/', '2d6'),
                exact: true
              },
              {
