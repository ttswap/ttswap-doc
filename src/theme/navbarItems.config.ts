...
export const chineseNavbarItems: NavbarItemConfig[] = [
  { to: '/zh/', label: '首页', position: 'left' },
  {
    ...
    position: 'left',
    items: [
      { to: '/docs/articles/publicsell', label: '公开发售' },
      { to: '/docs/articles/tokenairdrop', label: '代币空投' },
    ],
  },
  {
    label: '知识',
    position: 'left',
    items: [
      // { to: '/docs/knowledge/userdoc/userdoc', label: '用户文档' },
      { to: '/docs/knowledge/tokeneconomic', label: '代币经济' },
      // { to: '/docs/knowledge/whitepaper/whitepaper', label: '白皮书' },
    ],
  },
  {
    label: '加入DAO',
    position: 'left',
    items: [
      { to: '/docs/community/introduce', label: '按角色分配佣金' },
      { to: '/docs/community/recommander', label: '成为推荐人' },
      { to: '/docs/community/tokenoperator', label: '成为代币操作员' },
      { to: '/docs/community/gate', label: '成为服务提供商' },
      { to: '/docs/community/builder', label: '成为建设者' },
      { to: '/docs/community/liquidityprovider', label: '成为流动性提供者' },
      { to: '/docs/community/investor', label: '成为投资者' },
    ],
  },
